...
public class TankTurret {
	...
	public void setTankGun(TankGun tankGun) {
		this.tankGun = tankGun;
	}

	public TankTurret(float x, float y, float z, float width, float height, float length, Tank tank) {
		this.x = x;
		this.y = y;
		this.z = z;
		...
		this.angleX = 0;
		this.tankGun = new TankGun(0, 0, 0, 0.05f, 0.05f, 1.5f);
	}
